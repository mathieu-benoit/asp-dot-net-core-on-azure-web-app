Here is one example to Release an ASP.NET Core 2.0 web application to an App Service (Windows). You could adapt it with your own context, needs and constraints.
